...
function followerListBase(i) {
    return `#react-root > div > div > div > main > div > div > div > div > div > div > div:nth-child(2) > section > div > div > div > div:nth-child(${i}) > div > div > div > div:nth-child(2) > div:nth-child(1)`
}
...
module.exports = {
    ...
    // User List
    accountsList: '#react-root > div > div > div > main > div > div > div > div > div > div > div:nth-child(2) > div > section > div > div > div > div > div > div > div > div > div > div > a',
